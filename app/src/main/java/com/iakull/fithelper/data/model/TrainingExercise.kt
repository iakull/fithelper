...
class TrainingExerciseDiffCallback : DiffUtil.ItemCallback<TrainingExercise>() {
    override fun areItemsTheSame(oldItem: TrainingExercise, newItem: TrainingExercise) = oldItem.id == newItem.id
    override fun areContentsTheSame(oldItem: TrainingExercise, newItem: TrainingExercise) = oldItem == newItem
}